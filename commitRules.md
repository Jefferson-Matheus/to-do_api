...
- `brand` - Commits do tipo brand estão relacionados com os arquivos de identificação da marca (imagens, vídeos, logos), seja adicionando, removendo, renomeando... (não inclui alterações em código).
 ...
 <tbody>
   ...
   <tr>
    ...
    <tr>
      ...
      <td><code>feat</code> <code>fix</code></td>
    </tr>
    <tr>
      <td>Configuração</td>
    ...
    <tr>
      ...
      <td>🧱 GitHub: <code>:bricks:</code><br/>🏗️ GitLab: <code>:construction_site:</code></td>
      <td><code>ci</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>🧼 GitHub: <code>:soap:</code><br/>🚿 GitLab: <code>:shower:</code></td>
    ...
    <tr>
      <td>Screen</td>
      <td>🖼️ GitHub: <code>:framed_picture:</code><br/>🖼️ GitLab: <code>:frame_photo:</code></td>
      <td><code>feat</code> <code>fix</code></td>
    </tr>
    <tr>
    <tr>
    ...
    <tr>
      <td>Testes</td>
      <td>🧪 GitHub: <code>:test_tube:</code><br/>🐙 GitLab: <code>:octopus:</code></td>
      <td><code>test</code></td>
    </tr>
    <tr>
      <td>Texto</td>
    ...
    <tr>
      ...
      <td>🥅 GitHub: <code>:goal_net:</code><br/>🥅 GitLab: <code>:goal:</code></td>
      <td></td>
    </tr>
    <tr>
      <td>Dados</td>
      <td>🗃️ GitHub: <code>:goal_net:</code><br/>🗃️ GitLab: <code>:card_box:</code></td>
      <td><code>raw</code></td>
    </tr>
  </tbody>
</table>
